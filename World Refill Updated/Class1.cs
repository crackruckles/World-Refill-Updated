...
namespace WorldRefill_Updated
{
    ...
    public class TestPlugin : TerrariaPlugin
    {
        ...
        /// </summary>
        public override string Author => "Crackruckles";

        /// <summary>
        /// Gets the description of this plugin.
        /// A short, one lined description that tells people what your plugin does.
        /// </summary>
        public override string Description => "Updated World Refresh Plugin";

        /// <summary>
        /// Gets the name of this plugin.
        /// </summary>
        public override string Name => "World Refresh Updated";
